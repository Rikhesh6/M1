...
int main() {
    ...
    printf("Enter Numerator and Denominator for the first number: ");
    scanf("%d %d", &a1, &a2);

    printf("Enter Numerator and Denominator for the second number: ");
    scanf("%d %d", &b1, &b2);
...
## OUTPUT:
![image](https://github.com/user-attachments/assets/0ec8564a-19f3-46dc-9fc8-eba20ee99a76)
